 ...
 */
 ...
 module.exports = {
     ...
     entry: {
         ...
         productcategoryselectallpaged: ["./wwwroot/ts/MarshallStore/ProductCategory/DTOs/productcategorySelectAllPaged"],
         purchasetsmodel: ["./wwwroot/ts/MarshallStore/Purchase/TsModels/Purchase_TsModel"],
         purchasejquery: ["./wwwroot/ts/MarshallStore/Purchase/jQuery/PurchaseQuery_jQuery"],
         purchaseselectallpaged: ["./wwwroot/ts/MarshallStore/Purchase/DTOs/purchaseSelectAllPaged"],
         purchaseproducttsmodel: ["./wwwroot/ts/MarshallStore/PurchaseProduct/TsModels/PurchaseProduct_TsModel"],
         purchaseproductjquery: ["./wwwroot/ts/MarshallStore/PurchaseProduct/jQuery/PurchaseProductQuery_jQuery"],
         purchaseproductselectallpaged: ["./wwwroot/ts/MarshallStore/PurchaseProduct/DTOs/purchaseproductSelectAllPaged"],
         ratetsmodel: ["./wwwroot/ts/MarshallStore/Rate/TsModels/Rate_TsModel"],
         ratejquery: ["./wwwroot/ts/MarshallStore/Rate/jQuery/RateQuery_jQuery"],
